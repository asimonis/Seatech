...
PlotPresDrifts<-function(figtitle){
  ...
  plotPresGrid(UODF,start=min(GPSDF$UTC),end=max(GPSDF$UTC),type="presence",bin="minute",gps=GPSDF,title=paste0(figtitle,': Dolphins'),fill=UOColor,plotTz='America/Los_Angeles')
}
